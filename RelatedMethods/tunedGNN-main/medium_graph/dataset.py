...
from BenchmarkDataset import (  # noqa: E402
    CANONICAL_DATASETS,
...
SCAFFOLD_DATASETS = frozenset(CANONICAL_DATASETS)
...
def load_dataset(data_dir, dataname, sub_dataname=''):
    ...
    print(dataname)
    if dataname in SCAFFOLD_DATASETS:
        bundle = load_benchmark_bundle(data_dir, dataname)
        data = bundle.data
        fixed_splits = [
            {
